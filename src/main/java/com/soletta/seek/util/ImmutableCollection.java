...
public interface ImmutableCollection<E> {
     ...
     * @return <tt>true</tt> if this collection contains the specified element * @throws ClassCastException if the type
     *         of the specified element is incompatible with this collection (optional) * @throws NullPointerException
     ...
     * <p>
     * Suppose <tt>x</tt> is a collection known to contain only strings. The following code can be used to dump the
     * collection into a newly allocated array of <tt>String</tt>:
     * 
     * <pre>
     ...
     * 
     * @param a
     *            the array into which the elements of this collection are to be stored, if it is big enough; otherwise,
     *            a new array of the same runtime type is allocated for this purpose.
     * @return an array containing all of the elements in this collection * @throws NullPointerException if the specified
     *         array is null * @throws ArrayStoreException if the runtime type of the specified array is not a supertype
     ...
     * @return <tt>true</tt> if this collection contains all of the elements in the specified collection * @throws
     *         ClassCastException if the types of one or more elements in the specified collection are incompatible with
     *         this collection (optional) * @throws NullPointerException if the specified collection contains one or
     *         more null elements and this collection does not permit null elements (optional), or if the specified
     *         collection is null * @see #contains(Object)
     */
     ...
     * action is to rely on <tt>Object</tt>'s implementation, but the implementor may wish to implement a
     * "value comparison" in place of the default "reference comparison." (The <tt>List</tt> and <tt>Set</tt> interfaces
     ...
     * @see Set#equals(Object) @see List#equals(Object)
     */
    boolean equals(Object o);

    /**
     * Returns the hash code value for this collection. While the <tt>Collection</tt> interface adds no stipulations to
     * the general contract for the <tt>Object.hashCode</tt> method, programmers should take note that any class that
     * overrides the <tt>Object.equals</tt> method must also override the <tt>Object.hashCode</tt> method in order to
     * satisfy the general contract for the <tt>Object.hashCode</tt>method. In particular, <tt>c1.equals(c2)</tt>
     * implies that <tt>c1.hashCode()==c2.hashCode()</tt> .
     * 
