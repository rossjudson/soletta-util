...
public class LibBeans {
    ...
    /** Return a possibly nested property value from a target object, returning the default value
     * if the property can't be found. Note that if the property has a null value, null will be
     * returned, not the provided default.
     *  
     * @param <K>
     * @param target
