...
public class LibSets {
    ...
    /** Does the given set contain any of the items? If there are no items, it will return
     * false.
     * 
     * @param <T>
     * @param set
    ...
    /** Packs the given EnumSet into an integer by assigning each potential value of 
     * the set to a bit in a bit mask. 
     * 
     * @param eset
     * @return
     */
